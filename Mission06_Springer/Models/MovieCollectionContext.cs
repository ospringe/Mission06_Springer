...
{
    // As we create a MovieCollectionContext instance, we're giving a way in the constructor here to set up any options and include the base options in that setup.
